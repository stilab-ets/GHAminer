...
def save_builds_to_file(builds_info, output_csv):
    ...
    fieldnames = [
        ...
        'build_language','dependencies_count', 'workflow_size', 'test_framework', 'tests_passed', 'tests_failed', 'tests_skipped', 'tests_total',
...
def save_head(output_csv):
    ...
    fieldnames = [
        ...
        'tests_skipped', 'tests_total', 'fetch_duration'  # New field for fetch duration
    ]
