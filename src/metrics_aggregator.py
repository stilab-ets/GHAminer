...
def save_builds_to_file_old(builds_info, output_csv):
    ...
    fieldnames = [
        ...
        'gh_description_complexity', 'gh_src_files', 'gh_doc_files', 'gh_other_files', 'git_num_committers', 'git_commits',
        'gh_job_id', 'total_jobs', 'job_details', 'gh_first_commit_created_at', 'gh_team_size_last_3_month',
